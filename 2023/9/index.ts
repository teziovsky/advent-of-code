...
console.log("-----------------------");
console.log("EX1 Test Result: ", await ex1("2023/9/test1"));
console.log("EX1 Input Result: ", await ex1("2023/9/input"));
console.log("-----------------------");
console.log("EX2 Test Result: ", await ex2("2023/9/test2"));
console.log("EX2 Result: ", await ex2("2023/9/input"));
console.log("-----------------------");
